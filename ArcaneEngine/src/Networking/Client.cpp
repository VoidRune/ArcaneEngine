...
namespace Arc
{
	...
	void Client::ConnectionStatusChangedCallback(SteamNetConnectionStatusChangedCallback_t* status)
	{
		s_Instance->OnConnectionStatusChanged(status);
	}

	void Client::OnConnectionStatusChanged(SteamNetConnectionStatusChangedCallback_t* status)
	{
